        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I build full stack applications and explore AI/ML solutions,
                solving real-world problems through code, data, and
                intelligent systems.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I craft clean visuals and motion — from photo edits to short
                videos and 3D renders — to make projects look as good as they
                work.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
